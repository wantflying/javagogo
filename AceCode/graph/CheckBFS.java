...
class CheckBFS {
    ...
    public static String bfsVisit(Graph g, int source, boolean[] visited) {
        ...
        //Create ArrayAndStack.Queue for Breadth First Traversal and enqueue source in it
        ...
        while (!queue.isEmpty()) {
            ...
            //and if they are not already visited then enqueue them in the ArrayAndStack.Queue
